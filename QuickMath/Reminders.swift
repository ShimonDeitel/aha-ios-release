...
enum Reminders {
    private static let identifier = "aha.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Your daily Aha moment awaits"
        content.body = "A new concept is ready. Tap to expand your mind in 60 seconds."
